...
directoryItems = [
  {
    label: 'Clinics',
    svgPath: 'assets/icons/clinic.svg',
    bg: `linear-gradient(135deg, #fffde7 0%, #f9f5c7 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'clinics',
  },
  {
    label: 'NGOs',
    svgPath: 'assets/icons/ngo.svg',
    bg: `linear-gradient(135deg, #e6e6e6 0%, #d3d3d3 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'ngos',
  },
  {
    label: 'Events',
    svgPath: 'assets/icons/event.svg',
    bg: `linear-gradient(135deg, #ebf2ff 0%, #c1d2ff 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'events',
  },
  {
    label: 'ABC',
    svgPath: 'assets/icons/abc.svg',
    bg: `linear-gradient(135deg, #fffbea 0%, #f8f1c3 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'abc',
  },
  {
    label: 'Ambulance',
    svgPath: 'assets/icons/ambulance.svg',
    bg: `linear-gradient(135deg, #fff5f5ff 0%, #fcdada 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'ambulance',
  },
  {
    label: 'Boarding',
    svgPath: 'assets/icons/boarding.svg',
    bg: `linear-gradient(135deg, #f0e2d0 0%, #d7bea3 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'boarding',
  },
  {
    label: 'Govt Helpline',
    svgPath: 'assets/icons/helpline.svg',
    bg: `linear-gradient(135deg, #e4f1ff 0%, #cde2ff 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'ghelpline',
  },
  {
    label: 'Feeding',
    svgPath: 'assets/icons/feeding.svg',
    bg: `linear-gradient(135deg, #f1f1f1 0%, #dcdcdc 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'feeding',
  },
  {
    label: 'Medical Insurance',
    svgPath: 'assets/icons/insurance.svg',
    bg: `linear-gradient(135deg, #e8f3ff 0%, #d9eaff 100%), url('assets/img/noise.png')`,
    bgRepeat: 'repeat',
    route: 'insurance',
  }
];
